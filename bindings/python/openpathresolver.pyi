...
class IntegerConvertTypeError(Exception): ...
class JoinError(Exception): ...
class MismatchedFieldError(Exception): ...
class MissingItemError(Exception): ...
class MissingParentError(Exception): ...
class ParseError(Exception): ...
class ParseIntegerError(Exception): ...
class RegexError(Exception): ...
class ResolverTypeMismatchError(Exception): ...
class VariableRootPathError(Exception): ...
